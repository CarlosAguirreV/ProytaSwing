...
public interface Diccionario {
    ...
    String ACERCA = "<html>"
            ...
            + "<p>Para almacenar la información se emplea una pequeña base de datos SQLite. La base de datos se almacena en el archivo " + NOMBRE_ARCHIVO + " en " + System.getProperty("user.dir") + " de su equipo.<p></p>"
